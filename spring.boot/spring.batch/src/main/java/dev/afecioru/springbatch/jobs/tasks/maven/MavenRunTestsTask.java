...
public class MavenRunTestsTask extends Task {
  private static final String TASKLET_NAME = "mvn-run-tests";
  private static final Duration SLEEP_SECONDS = Duration.ofSeconds(14);
  ...
  public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
    ...
    log.info("[{}] Running Maven tests for repo {}", TASKLET_NAME, codeRepo.name());
