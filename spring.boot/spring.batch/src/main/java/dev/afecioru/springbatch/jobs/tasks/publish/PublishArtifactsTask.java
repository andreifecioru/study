package dev.afecioru.springbatch.jobs.tasks.publish;
...
public class PublishArtifactsTask extends Task {
  private static final String TASKLET_NAME = "publish-artifacts";
  ...
  public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
    ...
    log.info("[{}] Publishing artifacts for repo {}", TASKLET_NAME, codeRepo.name());
