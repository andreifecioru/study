package dev.afecioru.springbatch.jobs.tasks.oak;
...
public class OakScanTask extends Task {
  private static final String TASKLET_NAME = "oak-scan";
  private static final Duration SLEEP_SECONDS = Duration.ofSeconds(20);
