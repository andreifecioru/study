...
public class MavenResolveDependenciesTask extends Task {
  private static final String TASKLET_NAME = "mvn-resolve-deps";
  private static final Duration SLEEP_SECONDS = Duration.ofSeconds(7);
  ...
  public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
    ...
    log.info("[{}] Resolving Maven dependencies...", TASKLET_NAME);
