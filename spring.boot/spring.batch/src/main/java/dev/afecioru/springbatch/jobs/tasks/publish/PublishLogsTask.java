...
public class PublishLogsTask extends Task {
  private static final String TASKLET_NAME = "publish-logs";
  ...
  public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
    ...
    log.info("[{}] Publishing logs for repo {}", TASKLET_NAME, codeRepo.name());
