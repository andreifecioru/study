...
public class MavenInstallCacheExntensionTask extends Task {
  private static final String TASKLET_NAME = "mvn-install-cache-extension";
  private static final Duration SLEEP_SECONDS = Duration.ofSeconds(3);
  ...
  public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
    ...
    log.info("[{}] Installing Maven cache extension...", TASKLET_NAME);
