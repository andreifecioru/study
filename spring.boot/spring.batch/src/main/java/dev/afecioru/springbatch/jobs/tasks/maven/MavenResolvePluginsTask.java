...
public class MavenResolvePluginsTask extends Task {
  private static final String TASKLET_NAME = "mvn-resolve-plugins";
  private static final Duration SLEEP_SECONDS = Duration.ofSeconds(5);
  ...
  public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
    ...
    log.info("[{}] Resolving Maven plugins...", TASKLET_NAME);
